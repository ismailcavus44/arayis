...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 antialiased [color-scheme:light]">
      <Header />

      <PageHeroMedia title="İletişim" currentPage="İletişim" />

      <section className="border-t border-neutral-200 py-10 md:py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            <aside className="order-1 min-w-0 lg:order-2">
              <h2 className="text-lg font-semibold text-slate-900">İletişim</h2>
              <p className="mt-1 text-sm text-slate-600">Doğrudan ulaşım.</p>
              ...
              <ul className="mt-8 space-y-8 text-sm">
                ...
                <li className="flex gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 text-slate-600">
                      <a href="tel:+905052772628" className="hover:text-sky-600">
                        +90 505 277 2628
                      </a>
                    </p>
                  </div>
                ...
                <li className="flex gap-4">
                  ...
                  <div className="min-w-0">
                    <p className="font-medium text-slate-800">E-posta</p>
                    <p className="mt-1 text-slate-600">
                      <a href="mailto:info@arayisik.com" className="hover:text-sky-600">
                        info@arayisik.com
                      </a>
                    </p>
                  </div>
                ...
                <li className="flex gap-4">
                  ...
                  <div className="min-w-0">
                    <p className="font-medium text-slate-800">Çalışma saatleri</p>
                    <p className="mt-1 leading-relaxed text-slate-600">
            ...
            <div className="order-2 min-h-0 lg:order-1">
              <div className="h-full min-h-[350px] w-full overflow-hidden rounded-2xl border border-slate-100 bg-slate-100 shadow-lg">
                <iframe
              ...
              <form className="mt-6 space-y-5">
                ...
                <div className="flex items-start gap-3">
                  <input
                    ...
                    required
                    className="mt-1 h-4 w-4 shrink-0 rounded border-slate-300 bg-white text-sky-500 focus:ring-sky-500"
                  />
